...
<body>
  ...
  <div class="login">
  <h1>campu<span style="color:#78ADC9">search</span>  Admin</h1>
    <form method="post" id='login' action='<?php echo base_url('Usuario/entrar')  ?>'>
    ...
    if ($this->session->flashdata('erro') == TRUE){
      ...
      echo  '<strong>Erro</strong> E-mail ou senha estão incorretos';
      echo '</div>';
    } 
    ?>
</div>
