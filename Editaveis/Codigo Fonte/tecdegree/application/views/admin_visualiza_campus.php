...
<table class="table table-bordered table-striped">
    ...
    <?php
        foreach ($campus as $item){
            echo '<form action="detalhes_campus/'.$item->id.'" method="post">';
            echo '<tr>';
            echo '<td style="text-align:center;" class="" id="id">'.$item->id.'</td>';
            echo '<td class="" id="nome">'.$item->nome.'</td>';  
            echo '<td style="text-align:center;" class="" id="estado">'
                .$item->estado.'</td>';
            echo '<td style="text-align:center;" class="" id="telefone">'.$item->telefone.'</td>';
